...
const PageHeader = (props: Props) => {
  const { leftIcon, mainIcon, rightIcon, heading, placeholder, children } =
    props;
  return (
    <div className="w-full flex flex-col gap-8">
      <div className="w-full flex justify-center sm:justify-between items-center flex-wrap gap-8">
        <p className="text-primary text-4xl font-semibold">{heading}</p>
        <div className="relative md:mr-28">
          <PurpleIcon className="absolute -left-4 -top-3 -z-10 -rotate-45 py-2">
            {leftIcon}
          </PurpleIcon>
          <PurpleIcon className="z-10 background-blur">{mainIcon}</PurpleIcon>
